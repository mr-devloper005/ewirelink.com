...
const inputClass = 'h-[3.25rem] border border-white/25 bg-[#111] px-4 text-base font-bold text-white outline-none transition placeholder:text-white/35 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center border border-[var(--slot4-accent)] bg-transparent px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-[var(--slot4-accent)] disabled:opacity-60'
