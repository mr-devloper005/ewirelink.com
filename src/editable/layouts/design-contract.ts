...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#f8f8f8',
  '--slot4-panel-bg': '#161616',
  '--slot4-surface-bg': '#101010',
  '--slot4-muted-text': '#c8c8c8',
  '--slot4-soft-muted-text': '#8d8d8d',
  '--slot4-accent': '#ff5a1f',
  '--slot4-accent-fill': '#ff5a1f',
  '--slot4-accent-soft': '#32180f',
  '--slot4-dark-bg': '#080808',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#222222',
  '--slot4-cream': '#151515',
  '--slot4-warm': '#181818',
  '--slot4-lavender': '#ff5a1f',
  '--slot4-gray': '#202020',
  '--slot4-body-gradient': 'linear-gradient(180deg, #0e0e0e 0%, #141414 52%, #101010 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  shell: {
    ...
    section: 'mx-auto w-full max-w-[1340px] px-4 sm:px-6 lg:px-8',
    sectionY: 'py-12 sm:py-16 lg:py-20',
  },
  layout: {
    safeGrid: 'grid gap-px bg-white/15 md:grid-cols-2 xl:grid-cols-3',
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 border border-[var(--slot4-accent)] bg-transparent px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-[var(--slot4-accent-fill)]`,
    secondary: `inline-flex items-center justify-center gap-2 border border-white/35 bg-transparent px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:border-[var(--slot4-accent)] hover:text-[var(--slot4-accent)]`,
    accent: `inline-flex items-center justify-center gap-2 border border-[var(--slot4-accent)] bg-transparent px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-[var(--slot4-accent-fill)]`,
  },
  media: {
  ...
  motion: {
    lift: 'transition duration-300 hover:-translate-y-1 hover:border-[var(--slot4-accent)] hover:shadow-[0_18px_48px_rgba(255,90,31,0.16)]',
...
export const aiLayoutRules = [
  ...
  'Use a dark media-distribution studio layout, orange accents, bordered sections, and readable normal-width containers.',
