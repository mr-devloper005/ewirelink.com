  ...
  return (
    <EditableSiteShell>
      <main className="editable-section bg-[#111] text-white">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[1180px] border-x border-white/15 bg-[#131313] lg:grid-cols-[1.08fr_0.92fr]">
          <div className="flex flex-col justify-center border-b border-white/15 p-8 text-white sm:p-12 lg:border-b-0 lg:border-r lg:p-16">
          ...
          <div className="flex flex-col justify-center p-7 sm:p-12 lg:p-16">
            ...
            <p className="mt-5 border-t border-white/15 pt-5 text-sm text-white/65">New here? <Link href="/signup" className="font-black text-[var(--slot4-accent)] underline-offset-4 hover:underline">{pagesContent.auth.login.createCta}</Link></p>
          </div>
        </section>
      </main>
    </EditableSiteShell>
